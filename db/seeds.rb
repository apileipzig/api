Company.create(:branch_id => 1, :name => "hybrid art lab", :street => "Karl-Heine-Straße", :housenumber => 93, :housenumber_additional => "Tor B", :postcode => "04229", :city => "Leipzig", :phone_primary => "+49 341 12345-67", :mobile_primary => "+49 176 12345678", :email_primary => "hello@hybridartlab.com", :url_primary => "http://www.hybridartlab.com", :description => "Labor für interaktive Konzepte, tech-basierte Ideen und Prototypen.")
Company.create(:branch_id => 2, :name => "druck schmidt+partner", :street => "Industriestraße", :housenumber => 5, :housenumber_additional => "a", :postcode => "04229", :city => "Leipzig", :phone_primary => "+49 341 98765-43", :mobile_primary => "+49 176 87654321", :email_primary => "mail@druckschmidtpartner.de", :url_primary => "http://www.druckschmidtpartner.de", :description => "Eine tolle Druckerei.")
Company.create(:branch_id => 3, :name => "Filmproduktion Müller", :street => "Wilhelm-Leuschner-Platz", :housenumber => 12, :postcode => "04105", :city => "Leipzig", :phone_primary => "+49 341 11111-43", :phone_secondary => "+49 341 22222-44", :fax_primary => "+49 341 33333-43", :mobile_primary => "+49 176 88888888", :email_primary => "info@film-mueller.de", :url_primary => "http://www.film-mueller.de", :description => "Eine tolle Filmproduktionsfirma.")
Company.create(:branch_id => 3, :name => "ABC Movie&Print Media Group", :street => "Könneritzstraße", :housenumber => 104, :postcode => "04123", :city => "Leipzig", :phone_primary => "+49 341 454545-43", :phone_secondary => "+49 341 454545-44", :fax_primary => "+49 341 76567-43", :mobile_primary => "+49 176 876678", :email_primary => "info@abcmediagroup.de", :url_primary => "http://www.abcmediagroup.de", :description => "ABC Movie&Print Produktionen der Spitzenklasse.")
